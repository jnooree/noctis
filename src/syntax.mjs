export default [
  ...
  },
  {
    ...
    scope: [
      ...
      "source.toml punctuation.definition",
  ...
  },
  {
    ...
    scope: [
      ...
      "keyword.preprocessor.generator-expression.cmake",
    ],
    settings: {
      foreground: "#e4b781",
    },
  ...
  },
  {
    ...
    scope: [
      ...
      "string.interpolated.dollar.shell string.quoted.single.shell punctuation.definition.string",
    ],
    settings: {
      foreground: "#49e9a6",
    },
